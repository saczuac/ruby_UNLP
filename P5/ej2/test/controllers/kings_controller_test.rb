...
class KingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create king" do
    assert_difference('King.count') do
      post kings_url, params: { king: { date_since: @king.date_since, date_until: @king.date_until, kingdom: @king.kingdom, name: @king.name } }
    end
  ...
  test "should update king" do
    patch king_url(@king), params: { king: { date_since: @king.date_since, date_until: @king.date_until, kingdom: @king.kingdom, name: @king.name } }
